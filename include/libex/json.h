...
//typedef enum { JSON_OBJECT, JSON_ARRAY, JSON_STRING, JSON_INTEGER, JSON_DOUBLE, JSON_TRUE, JSON_FALSE, JSON_NULL } json_type_t;
...
typedef enum { JSONRPC_VNONE, JSONRPC_V10, JSONRPC_V20 } jsonrpc_ver_t;
typedef struct {
    jsonrpc_ver_t ver;
    json_item_t *id;
    strptr_t method;
